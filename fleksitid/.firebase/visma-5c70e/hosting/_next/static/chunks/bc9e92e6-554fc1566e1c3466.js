"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{ET:function(){return addDoc},JU:function(){return doc},PL:function(){return getDocs},QT:function(){return getDoc},ad:function(){return getFirestore},hJ:function(){return collection},oe:function(){return deleteDoc},pl:function(){return setDoc}});var n,i,s=r(3991),a=r(5538),o=r(6914),l=r(8745),u=r(613),c=r(2601);let _="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let FieldPath=class FieldPath{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new FirestoreError(m.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new FieldPath$1(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
