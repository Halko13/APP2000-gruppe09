...
export default function Hjem() {
  ...
  return (
    <Box sx={{ bgcolor: 'grey.50', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', position: 'relative' }}>
      <Head>
        <title>Startside</title>
      </Head>

      <Typography variant="h2" sx={{ position: 'absolute', top: 450, left: 1200, fontWeight: 'bold' }}>
        {gjeldendeTid}
      </Typography>

      <Box sx={{ textAlign: 'center' }}>
        <Typography variant="h4" sx={{ mb: 2, fontWeight: 'bold', color: 'grey.1000', boxShadow: 1000 }}>
